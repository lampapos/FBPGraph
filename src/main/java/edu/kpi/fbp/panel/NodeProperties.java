...
public class NodeProperties {
  ...
  public NodeProperties(final mxGraphComponent g, final Connect con) {
    this.work = g;
    this.conDes = con;
  }
  ...
  public JPanel generateJP(final ArrayList<Node> nodes, final int iter) {
    ...
    final JScrollPane hint = new JScrollPane(new JTextField(target.getDescription()));
    ...
    P.setLayout(null);
    final JTextField t = new JTextField("Please select cell.");
      t.setEditable(false);
