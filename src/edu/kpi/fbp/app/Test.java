...
public class Test extends JFrame {
  ...
  public Test() {
    ...
    final mxGraph graph = new mxGraph() {
      ...
      public void drawState(final mxICanvas canvas, final mxCellState state, final boolean drawLabel) {
        final String label = (drawLabel) ? state.getLabel() : "";
    ...
    try {
      ...
      final Object v1 = graph.insertVertex(parent, null, "Hello", 20, 20, 80, 30);
      final Object v2 = graph.insertVertex(parent, null, "World!", 240, 150, 80, 30);
  ...
  public class SwingCanvas extends mxInteractiveCanvas {
    ...
    public SwingCanvas(final mxGraphComponent graphComponent) {
    ...
    public void drawVertex(final mxCellState state, final String label) {
