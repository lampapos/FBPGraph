...
public class Gui extends JApplet {
  ...
  private int cell_i = -1, max_id = 0;

  private final WorkField W = new WorkField();
  private final Components C = new Components("../res/comp.xml");

  private final JPanel elements = new JPanel();
  private JScrollPane jsp = new JScrollPane();
  private final JPanel jsp2 = new JPanel();
  private final mxGraphComponent work = W.createMXGraph(W.nodes);
